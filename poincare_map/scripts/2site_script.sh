...
number=$SGE_TASK_ID
paramfile=/home/ucapjmd/Scratch/inputs/quadrants_starting_points.txt
...
python /home/ucapjmd/Scratch/scripts/2site_simulation.py $variable1 $variable2 $variable3 $index
